      ...
      <Link href={`/detail/${product.ProductId}`}>
            ...
            <div className='flex justify-between mb-2'>
              <div>
                ...
                ><Link href={`/shop/edit/${product.ProductId}`}>Edit</Link></div>
              </div>
                ...
                <div className="fixed inset-0 flex items-center justify-center">
                    <div className="modalproduct pdcard p-8 rounded-md shadow-lg z-10 flex">
                      <div className='w-full p-4'>
                          <div className='h-3/4'>
                              <p><img className='mx-auto' src={selectedProduct.ImagePath} width={500} height={500} alt={product.ProductName} loading="lazy"/></p>
                          </div>
                      </div>
