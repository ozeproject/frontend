...
const CartSuccess: React.FC<CartSuccessProps> = ({ onClose }) => {
        ...
        <div className="fixed inset-0 flex items-center justify-center">
            <div className="pdcard p-8 rounded-md shadow-lg w-1/4 h-88">
                ...
                <div className='text-center'>
                    <div className='text-green-600 mt-8 text-2xl'>Added to cart</div>
                    <div className='mt-4 font-semibold'>You have added to cart</div>
                    <div>
                        <button
