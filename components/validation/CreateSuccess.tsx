...
const CreateSuccess: React.FC<CreateSuccessProps> = ({ onClose }) => {
        ...
        <div className="fixed inset-0 flex items-center justify-center">
            <div className="pdcard p-8 rounded-md shadow-lg w-1/4 h-88">
                ...
                <div className='text-center'>
                    <div className='text-green-600 mt-8 text-2xl'>Create Successful!</div>
                    <div className='mt-4 font-semibold'>You have successfully created item</div>
                    <div>
                        <button
