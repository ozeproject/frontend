      ...
      <div className="pdcard p-8 rounded-md shadow-lg w-1/4 h-88">
        ...
        <div className="text-center">
          ...
          <div className="mt-4 font-semibold text-xl">
            You have successfully payment order id :{router.query.index}
          </div>
          <div>
            <button
