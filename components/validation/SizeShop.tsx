...
const SizeShop: React.FC<SizeShopProps> = ({ onClose }) => {
        ...
        <div className="fixed inset-0 flex items-center justify-center">
            <div className="pdcard p-8 rounded-md shadow-lg w-1/4 h-88">
                ...
                <div className='text-center'>
                    <div className='text-red-600 mt-8 text-2xl'>Can not Add</div>
                    <div className='mt-4 font-semibold'>Please Select Size First!</div>
                    <div>
                        <button
