  ...
  return (
    ...
    <div  className=" border-gray-500  border-r-2">
        <div className="product p-6 ">
            ...
            <div className='text-center '><Image className='mx-auto' src="" width={400} height={400} alt="testIMG" loading="lazy"/></div>

            <div className='text-center'><span>ProductName </span></div>
            ...
            <div className="hideforhold mt-4">
                ...
                <div className='mt-4'>
                  ...
                  >
                    ...
                    <button
                    className="white-button border-solid border-2 deletebtn rounded-md mt-3 p-2 mx-2 w-1/6 "
                    >
                        Delete
                    </button>
                </div>
